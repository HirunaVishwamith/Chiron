//**************************************************************************
// GL_tty.h from Bruno Levy Tinyprograms
//--------------------------------------------------------------------------
// Hiruna Vishwamith
// UOM
// 21/03/2025
//
// A couple of function to display graphics in the terminal, using ansi sequences.
// Added baremetal suport the pixels gets visualize by writing into a uart buffer using ASCI scape characters.
...
// You can define GL_width and GL_height before #including GL_tty.h in case the plain
