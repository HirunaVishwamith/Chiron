...
class simulator {
  ...
  string return_registers() {
    ...
    output << "x0:  " << std::hex << std::setw(16) << std::setw(16) << tb->registersOut0_0  << " "
           << "x1:  " << std::hex << std::setw(16) << std::setw(16) << tb->registersOut0_1  << " "
           << "x2:  " << std::hex << std::setw(16) << std::setw(16) << tb->registersOut0_2  << " "
           << "x3:  " << std::hex << std::setw(16) << std::setw(16) << tb->registersOut0_3  << " "
           << "x4:  " << std::hex << std::setw(16) << std::setw(16) << tb->registersOut0_4  << " "
           << "x5:  " << std::hex << std::setw(16) << std::setw(16) << tb->registersOut0_5  << " "
           << "x6:  " << std::hex << std::setw(16) << std::setw(16) << tb->registersOut0_6  << " "
           << "x7:  " << std::hex << std::setw(16) << std::setw(16) << tb->registersOut0_7  << "\n";

    output << "x8:  " << std::hex << std::setw(16) << std::setw(16) << tb->registersOut0_8  << " "
           << "x9:  " << std::hex << std::setw(16) << std::setw(16) << tb->registersOut0_9  << " "
           << "x10: " << std::hex << std::setw(16) << std::setw(16) << tb->registersOut0_10 << " "
           << "x11: " << std::hex << std::setw(16) << std::setw(16) << tb->registersOut0_11 << " "
           << "x12: " << std::hex << std::setw(16) << std::setw(16) << tb->registersOut0_12 << " "
           << "x13: " << std::hex << std::setw(16) << std::setw(16) << tb->registersOut0_13 << " "
           << "x14: " << std::hex << std::setw(16) << std::setw(16) << tb->registersOut0_14 << " "
           << "x15: " << std::hex << std::setw(16) << std::setw(16) << tb->registersOut0_15 << "\n";

    output << "x16: " << std::hex << std::setw(16) << std::setw(16) << tb->registersOut0_16 << " "
           << "x17: " << std::hex << std::setw(16) << std::setw(16) << tb->registersOut0_17 << " "
           << "x18: " << std::hex << std::setw(16) << std::setw(16) << tb->registersOut0_18 << " "
           << "x19: " << std::hex << std::setw(16) << std::setw(16) << tb->registersOut0_19 << " "
           << "x20: " << std::hex << std::setw(16) << std::setw(16) << tb->registersOut0_20 << " "
           << "x21: " << std::hex << std::setw(16) << std::setw(16) << tb->registersOut0_21 << " "
           << "x22: " << std::hex << std::setw(16) << std::setw(16) << tb->registersOut0_22 << " "
           << "x23: " << std::hex << std::setw(16) << std::setw(16) << tb->registersOut0_23 << "\n";

    output << "x24: " << std::hex << std::setw(16) << std::setw(16) << tb->registersOut0_24 << " "
           << "x25: " << std::hex << std::setw(16) << std::setw(16) << tb->registersOut0_25 << " "
           << "x26: " << std::hex << std::setw(16) << std::setw(16) << tb->registersOut0_26 << " "
           << "x27: " << std::hex << std::setw(16) << std::setw(16) << tb->registersOut0_27 << " "
           << "x28: " << std::hex << std::setw(16) << std::setw(16) << tb->registersOut0_28 << " "
           << "x29: " << std::hex << std::setw(16) << std::setw(16) << tb->registersOut0_29 << " "
           << "x30: " << std::hex << std::setw(16) << std::setw(16) << tb->registersOut0_30 << " "
           << "x31: " << std::hex << std::setw(16) << std::setw(16) << tb->registersOut0_31 << "\n";
